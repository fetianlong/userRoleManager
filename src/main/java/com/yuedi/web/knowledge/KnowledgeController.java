package com.yuedi.web.knowledge;
...
import com.yuedi.dao.KnowledgeDao;
...
import com.yuedi.service.KnowledgeService;
...
public class KnowledgeController extends SupperController {
	...
	private static String resource = "http://192.168.0.251/yuedi-resource/resources/picture/knowledge/";//正式路径
	private static String imageResource = "http://192.168.0.251/yuedi-resource/resources/picture/";//正式路径
