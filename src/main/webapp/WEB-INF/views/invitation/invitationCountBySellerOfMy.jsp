...
// 	$("#addInvitationBySeller").click(function(){
// 		window.open("${ctx}/invitation/buyInvitation?parentId=${parentId}&titleName=购买邀请码&sellerId=${sellerId}");
// 	});
	//查询重置
...
<%-- 	            <a id="addInvitation" href="" class="iconlink2" style="float:right; margin-right:10px;"><img src="${ctx}/demo/images/icons/small/black/plus.png" class="mgright5" alt=""> <span>单个新增</span></a>       --%>
	            <a id="addInvitationBySeller" href="${ctx}/invitation/buyInvitation?parentId=${parentId}&titleName=购买邀请码&sellerId=${sellerId}" class="iconlink2" style="float:right; margin-right:10px;"><img src="${ctx}/demo/images/icons/small/black/plus.png" class="mgright5" alt=""> <span>购买邀请码</span></a>      
	        </div>
