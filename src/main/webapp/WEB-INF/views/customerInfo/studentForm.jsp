...
<body>
 <div class="xuey-dj">
       <h3>登记学员信息</h3>
       <span><img class="xy-close" src="${ctx}/static/images/closeicon.png" /></span>
       <!--基本信息-->
       <form id="customerInfo" action="${ctx}/customerInfo/convertStudent" method="post">
       <div class="jbinfo">
		<h4>基本信息</h4>
           <div class="line1">  
               <label>姓名</label>
               ...
               <label>移动电话</label>
               <input  type="text" name="mobilePhone" value="${customerInfo.mobilePhone}" />
              <label>出生日期</label>
               <input class="date-inp" id="bornDate" value="${customerInfo.bornDate}" name="bornDate" onClick="return Calendar('bornDate');"  type="text" placeholder="" readonly="readonly"/> <a><img class="dateBtn" value="" onClick="return Calendar('bornDate');" src="${ctx}/static/images/rilicon.png"  /></a>
           </div>
           ...
           <div class="line1">  
               ...
               <label>身份证</label>
               <input  type="text" name="cardCode" value="${customerInfo.cardCode}" />
               <label>邮箱</label>
            ...
            <div class="line1">  
               <label>固定电话</label>
               <input  type="text" name="fixedPhone" value="" />
               <label>QQ</label>
               <input  type="text" name="qqAccount" value="" />
               <label>微信</label>
               <input  type="text" name="microChartAccount" value="" />
           </div>
            <div class="line1">  
               <label>入学日期</label>
               <input class="date-inp" id="entranceDate" name="entranceDate" onClick="return Calendar('entranceDate');"  type="text" placeholder="" readonly="readonly"/> <a><img class="dateBtn" value="" onClick="return Calendar('entranceDate');" src="${ctx}/static/images/rilicon.png"  /></a>
               <label>推荐人</label>
               <select class="required" name="saler">
					<option value="">-----请选择-----</option>
					<c:set var="userInfoId" value="${userInfo.sellerId}" />
				<c:forEach items="${userInfoList}" var="userInfo">
					<option value="${userInfo.id}" <c:if test="${userInfo.id eq userInfoId}">selected="selected"</c:if>>${userInfo.userName}</option>
				</c:forEach>
			  </select>
               <label>居住地址</label>
               <input  type="text" name="specificationAddress" value="" />
           </div>
            <div class="line1">  
               <label>居住省</label>
       ...
       <div class="jbinfo jbinfo2">
		<h4>孕育信息</h4>
           <div class="line1">  
               <label>最后月经日期</label>
               <input class="date-inp" id="lastMensesDate" name="lastMensesDate" onClick="return Calendar('lastMensesDate');"  type="text" placeholder="" readonly="readonly"/> <a><img class="dateBtn" value="" onClick="return Calendar('lastMensesDate');" src="${ctx}/static/images/rilicon.png"  /></a>
               <label>预产期</label>
               <input  type="text" name="expectedDate" value="" />
               <input class="date-inp" id="expectedDate" name="expectedDate" onClick="return Calendar('expectedDate');"  type="text" placeholder="" readonly="readonly"/> <a><img class="dateBtn" value="" onClick="return Calendar('expectedDate');" src="${ctx}/static/images/rilicon.png"  /></a>
               <label>月经周期</label>
               <input  type="text" name="mensesDays" value="" />
           </div>
           <div class="line1">  
               <label>实际生产日期</label>
               <input class="date-inp" id="rellyBornDate" name="rellyBornDate" onClick="return Calendar('rellyBornDate');"  type="text" placeholder="" readonly="readonly"/> <a><img class="dateBtn" value="" onClick="return Calendar('rellyBornDate');" src="${ctx}/static/images/rilicon.png"  /></a>
               <label>胎数</label>
               <input  type="text" name="bodySize" value="" />
               <label>生产方式</label>
                <select name="sex">
	              <option value="">-----请选择-----</option>
