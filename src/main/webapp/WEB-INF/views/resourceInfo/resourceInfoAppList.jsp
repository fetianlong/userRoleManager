...
$(document).ready(function () {
	...
	$("#updateKnowledge").click(function() {
		if($("input[type='checkbox']:checked").val() == undefined){
			...
			$("#updateKnowledge").attr("href",'${ctx}/resourceInfo/update/'+knowledgeId+'?parentId=' + parentId + "&titleName=修改APP资料");
		}
    });
	...
	$("#deleteKnowledge").click(function() {
		if($("input[type='checkbox']:checked").val() == undefined){
			...
			if(boolconfirm) {
				$("#deleteKnowledge").attr("href",'${ctx}/resourceInfo/delete/'+knowledgeId+'?parentId=' + parentId);
			}
		}
    });
...
// 		alert(resourceType);
	...
	function loadNoSelectResourceData() {
		var url = "${ctx}/deliveryResource/selectAppResourceInfo/";
		var brandId =$("div[name='selectBrand_list'][class*='filter-div-selected']").attr("codeValue");
		var resourceType =$("div[name='selectResourceType_list'][class*='filter-div-selected']").attr("codeValue");
    ...
    <div class="yaop-info mainav activity-gl ">
        <div class="menu2-info act-z"> 
			...
			<div class="sTableOptions" style="margin-left:16px; margin-top:20px;">
	            ...
	            <a id="selectDelivery" href="${ctx}/resourceInfo/add?parentId=${parentId}&titleName=新增APP资源" class="iconlink2" style="float:right;margin-right:10px;"><img src="${ctx}/demo/images/icons/small/black/plus.png" class="mgright5" alt=""> <span>新增</span></a>
