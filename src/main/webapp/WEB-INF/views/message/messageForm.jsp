...
<body>
       <div class="hd-add actionbox">
         ...
         <form id="message" action="${ctx}/message/addMessage" method="post">
          <table class="hd-tab" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="font">短信内容</td>
                  <td><textarea class="area-inp" style=" margin-top:10px;" name="messageContext" cols="" rows="">${message.messageContext}</textarea>
                  <span>*</span></td>
                </tr>
                <tr>
                  <td class="font">申请原因</td>
                  <td><textarea class="area-inp" style=" margin-top:10px;" name="applyReason" cols="" rows="">${message.applyReason}</textarea></td>
                </tr>
          </table>
